  ...
  return (
    <div className={styles.creators__list}>
        ...
        creatorsToShow.map((creator, i) =>
          <Link className={styles.creators__item} key={i} href='/'>
            <div className={styles.creators__image}>
              <Image src={creator.imageUrl || "/images/creators/unnamed.png"} width={128} height={128}
      ...
      }
      {
        ...
        <CustomButton clickCallback={() => setShowAllCreators(true)} type="dark">Показать ещё</CustomButton>
      }
    </div>
  )
}
